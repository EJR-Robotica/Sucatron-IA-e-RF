...
<link rel="stylesheet" media="screen" type="text/css" href="css/modulo2.css" />
...
<div id="corpo">
	...
	<div id="painel_esquerdo">
	   ...
	   <textarea id="container_programa" readonly ></textarea>
	</div>
...
<input type="hidden" name="tipomedida" id="passo1" value="<?php echo $tipomedida ?>">
