...
<script type="text/javascript" src="modulo3.js"></script>
<link rel="stylesheet" media="screen" type="text/css" href="css/modulo3.css" />
...
<div id="corpo">
    <div id="painel_esquerdo">
        <textarea id="container_programa"></textarea>
    </div>
