...
var botoes = [ 
	...
	{element: "input",id:"txt_frase",comando:"", funcao:"nenhuma", class: "btn_input_text", width:"245px", height: "30px"},
...
$(document).ready( function(){
	...
	//window.setInterval( atualiza_conteudo, 10000 );
...
function comandos_tipo_medida (valor) {
