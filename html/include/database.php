...
$conn_string = "mysql:host=".$conn_host.";port=".$conn_port.";dbname=".$conn_banco.";charset=utf8";
$conn = new  SafePDO($conn_string, $conn_usuario, $conn_senha, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
...
function executeDelete($conexao, $tabela, $dados ){
